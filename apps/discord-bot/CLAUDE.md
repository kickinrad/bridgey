...
The bot runs from `dist/bot.js` (esbuild bundle, discord.js/zod external). The Claude Code control surface (skills, hooks, manifest) lives separately at `plugins/bridgey-discord/`.
